# 🏆 Decathlon Digital Challenge : Devenez le CTO de Votre Santé Posturale
...
Ce projet est une application **React** standard.
...
1. Clonez le dépôt :
   ```bash
   git clone https://github.com/votre-username/decathlon-posture.git